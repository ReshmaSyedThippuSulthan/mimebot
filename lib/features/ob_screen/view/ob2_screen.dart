...
import 'package:mimebot/features/ob_screen/view/ob3_screen.dart';

class OB2Screen extends StatefulWidget {
  const OB2Screen({super.key});

  @override
  State<OB2Screen> createState() => _OB2ScreenState();
}

class _OB2ScreenState extends State<OB2Screen> {
  Ob1Model? data;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      print("print ob1");
      data = await Ob1Controller.splashScreenob1("2");
      setState(() {
        isLoading = false;
      });
    });
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => const OB3Screen(),
                                  ));
                                },
                                child: const Text(
                                  "Next",
